...
import executeRequest from '@salesforce/apex/ExecuteSegmentRevenueTransaction.executeSupplyDatabase';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class ExecuteSupplyDBSegmentRevenutAssignment extends LightningElement {
    @api batchSize;
    handleClick(event){
